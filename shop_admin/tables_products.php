<?php 
    ...
    getDB();
    $action = filter_input(INPUT_POST, 'add_new');
    if(isset($action)){
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title m-b-0"><form action="" method="POST">
                            ...
                            <table class="table">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>                                    
                                      ...
                                      <td>
                                        <img src="images/products/<?php echo $value['image']?>" height='80'>
                                      </td>
                                      <td><?php echo $value['create_at'] ?></td>
                                      <td><?php echo $value['update_at'] ?></td>
                                      <td></td>
                                      <td><a href="form_edit_product.php?action=edit&productID=<?php echo $value['productID'] ?>">Edit</a></td>
