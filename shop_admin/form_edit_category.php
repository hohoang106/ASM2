<?php 
    ...
    if($action=='update'){
        ...
        update_category($categoryID,$categoryName,$description);
                            ...
                            <form class="form-horizontal" method="POST" action="">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <input type="hidden" name="categoryID" value="<?php $category['categoryID'] ?>">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Category Name</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="categoryName" class="form-control" id="fname" placeholder="Category Name" value="<?php echo $category['categoryName'] ?>">
                                        </div>
                                    </div>                   
